...
import com.example.chatapplication.databinding.GroupReceivedItemBinding;
...
public class GroupMessageAdaptor extends RecyclerView.Adapter{
    ...
    public GroupMessageAdaptor() {
    }

    public GroupMessageAdaptor(Context context, ArrayList<MessageModel> messageModelArrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == ITEM_SEND){
            ...
            view = LayoutInflater.from(context).inflate(R.layout.group_received_item,parent,false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass() == SendViewHolder.class){
            ...
            if(url != null){
                ...
                receivedViewHolder.binding.receiverName.setText(messageModel.getSenderName());
    ...
    public class ReceivedViewHolder extends RecyclerView.ViewHolder{
        ...
        GroupReceivedItemBinding binding;

        public ReceivedViewHolder(@NonNull View itemView) {
            super(itemView);

            binding = GroupReceivedItemBinding.bind(itemView);
